...
if ($_COOKIE['page'] == 'fact'){
    echo 'Вы последний раз заходили на страницу <a href="fact.php">Fact</a>';
} elseif ($_COOKIE['page'] == 'bitrix') {
    echo 'Вы последний раз заходили на страницу <a href="bitrix.php">Bitrix</a>';
}
...
<main class="main-<?php echo $time; ?>" style="background-color: <?= $bgColor; ?>">
    <div class="main-grid">
        ...
        <div class="main-reviews">
            ...
            $textReviewsMain = 'Нравится, что наконец то начался хардкор, меньше болтаем и больше делаем)';
    ...
    $text = '<div class="eu1-grid ' . $time . '" >
        ...
        <div class="box box4 light">
            <div class="img-block"><img src="img/eu4.jpg" alt="eu4" title="eu4"></div>
            <br>
            <br>
    ...
    <div class="container-grid ' . $time . '">
        <div class="grid-block-one">
            <div class="grid-photo"><img src="img/eu5.jpg" alt="eu5" title="eu5"></div>
            <br>
            <br>
        ...
        <div class="grid-block-two">
            <div class="grid-photo"><img src="img/eu6.jpg" alt="eu6" title="eu6"></div>
            <br>
            <br>
        ...
        <div class="grid-block-three">
            <div class="grid-photo"><img src="img/eu7.jpg" alt="eu7" title="eu7"></div>
            <br>
            <br>
        ...
        <div class="grid-block-four">
            <div class="grid-photo"><img src="img/eu8.jpg" alt="eu8" title="eu8"></div>
            <br>
            <br>
